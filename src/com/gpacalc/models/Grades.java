...
public class Grades {
  ...
  public static int letterToNumericalValue(double score) {
    String letterGrade = scoreToLetter(score);
  ...
  public static double calculateGPA(Course[] courses) {
    ...
    for (Course course : courses) {
      double gradePoint = letterToNumericalValue(course.getScore());
